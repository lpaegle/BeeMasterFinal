...
//    FIND LOCATION FOR ADDED HIVE FOR RECORD IN HISTORY TABLE
    ...
    public void sumOfHoneyAndPollen(Colony colony) {
        try {
            ...
            System.out.println("There are " + honeySum + " kg of honey and " + pollenSum + " kg of pollen in hives in total.");
    ...
    public void varroaTreatmentCount(Colony colony) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                System.out.println(varCount + " hive/s treated with '" + varroaTreatment + "' treatment.");
            }
            System.out.println("");
    ...
    public void coloniesInfo(Colony colony) {
        try {
            ...
            while (resultSet.next()) {
                ...
                System.out.println("There are " + honey + " kg of honey.");
                System.out.println("There are " + pollen + " kg of pollen");
                System.out.println("The colony was treated with '" + varroaTreatment + "' varroa treatement.");
                System.out.println("The food added: " + foodAdded);
...
// GET ALL ACTIONS YOU HAVE DONE IN LAST VISIT
    ...
    public void attachKgHoney(Colony colony) {
        try {
            ...
            System.out.println("Error adding kg of honey: " + exception);
        }
    }
    ...
    public void attachPollen(Colony colony) {
        try {
            ...
            System.out.println("Error adding kg of pollen: " + exception);
        }
    }
...
//    WHERE hive_id=6;
    ...
    public void updateHiveStatus(Hive hive, Colony colony) {
        try {
            ...
            sqlStatement = "UPDATE hives SET hive_status = 'Taken' WHERE hive_id = '" + colony.getHiveId() + "'";
            statement.execute(sqlStatement);
